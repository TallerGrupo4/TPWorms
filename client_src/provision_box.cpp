...
ProvisionBox::ProvisionBox(const ProvisionBoxSnapshot& box_snpsht,
...
void ProvisionBox::update_from_snapshot(SDL2pp::Renderer& renderer,
                                        const ProvisionBoxSnapshot& box_snpsht) {
    state = box_snpsht.state;
    x = box_snpsht.pos_x;
    y = (-1) * box_snpsht.pos_y;
