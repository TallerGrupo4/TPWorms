...
//     x = proj_snpsht.pos_x;
//     y = (-1)*proj_snpsht.pos_y;
//     proj_an.update_from_snapshot(state, angle, facing_left);
// }

// void Projectile::update_from_iter(int iter) {
//     for (int i = 0; i < iter; i++) {
//         proj_an.update_from_iter(state, angle, facing_left);
//     }
// }
...
//     proj_an.render(state, angle, renderer, SDL2pp::Rect(top_left_x, top_left_y, width*RESOLUTION_MULTIPLIER,
