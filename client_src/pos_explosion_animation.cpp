...
PosExplosionAndAnimation::PosExplosionAndAnimation(int x, int y, SDL2pp::Renderer& renderer,
                                                   SDL2pp::Surface& surface, uint seconds_for_an,
                                                   bool an_is_looped, int explosion_size):
        x(x),
        y(y),
