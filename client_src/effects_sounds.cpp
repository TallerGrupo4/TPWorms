...
EffectsSounds::EffectsSounds(SDL2pp::Mixer& mixer):
        mixer(mixer),
        /*PICKUP BOX*/
...
void EffectsSounds::play_pickup_box_sound() { mixer.PlayChannel(-1, pickup_box_sound, 0); }

void EffectsSounds::play_match_winner_sound() { mixer.PlayChannel(-1, match_winner_sound, -1); }

void EffectsSounds::play_match_loser_sound() { mixer.PlayChannel(-1, match_loser_sound, -1); }

void EffectsSounds::play_big_explosion_sound() { mixer.PlayChannel(-1, big_explosion_sound, 0); }
...
void EffectsSounds::play_powerup_sound() { mixer.PlayChannel(-1, powerup, 0); }

void EffectsSounds::play_bazooka_shoot_sound() { mixer.PlayChannel(-1, bazooka_shoot, 0); }
...
void EffectsSounds::play_teleport_sound() { mixer.PlayChannel(-1, teleport_sound, 0); }
...
void EffectsSounds::stop_dynamite_fuse_sound() { mixer.HaltChannel(SPECIAL_EXPLOSIONS_CHANNEL); }
