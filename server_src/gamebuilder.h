...
public:
    ...
    void create_small_platform(float x, float y) { create_platform(x, y, PLAT_SMALL, PLAT_HEIGHT); }

    void create_big_platform(float x, float y) { create_platform(x, y, PLAT_BIG, PLAT_HEIGHT); }
