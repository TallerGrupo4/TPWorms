...
Bazooka::Bazooka() : Weapon(BAZOOKA, INF_AMMO , INF_AMMO , BAZOOKA_DAMAGE, BAZOOKA_RADIUS, 0, EXPLOSIVE, BazookaProj, true, true, true) {}

bool Bazooka::use(b2Body* worm, int direction, float angle , int time,  int power , float x , float y, ProjectileManager& projectiles){
