...
RedGranade::RedGranade() : Weapon(RED_GRANADE, RED_GRANADE_MAX_AMMO , RED_GRANADE_MAX_AMMO , RED_GRANADE_DAMAGE, RED_GRANADE_RADIUS, RED_GRANADE_FRAGMENTS , EXPLOSIVE_TIMER, RED_GRANADE_PROJECTILE, false, true, true) {}
