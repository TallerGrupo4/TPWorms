...
Dynamite::Dynamite() : Weapon(DYNAMITE, DYNAMITE_MAX_AMMO/2 , DYNAMITE_MAX_AMMO , DYNAMITE_DAMAGE, DYNAMITE_RADIUS, 0 , EXPLOSIVE_TIMER, DynamiteProj, false, false, false) {}

bool Dynamite::use(b2Body* worm, int direction, float angle , int time,  int power , float x , float y, ProjectileManager& projectiles){
