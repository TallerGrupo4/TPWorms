...
Match::Match(std::string map_route): name(),  world(b2Vec2(0, -10)), builder(world), keep_running(true), match_started(false), players(),  queue(QUEUE_MAX_SIZE), turn(0), id_counter(0) {
